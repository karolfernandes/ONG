 ...
 * @author ALUNO
 */
public class TelaRetiradaDoaocoes extends javax.swing.JFrame {

    /**
     * Creates new form Relatorios
     */
    public TelaRetiradaDoaocoes() {
        initComponents();
    }
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRetiradaDoaocoes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaRetiradaDoaocoes().setVisible(true);
            }
        });
    }
